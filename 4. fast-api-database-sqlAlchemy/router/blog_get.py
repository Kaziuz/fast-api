from router.blog_post import required_functionality # esto es una funcion que esta en otro archivo, y que podemos usar en cualquier parte del codigo
...
# Esto actua como como un un selector en el swagger
