...
# Aqui vamos a definir una funcion que podremos usar en cualquier parte del codigo
# es llamado en python dependencies
def required_functionality():
  return {'message': 'This is a required functionality example'}